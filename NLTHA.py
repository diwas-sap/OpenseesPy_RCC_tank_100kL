...
# CSV_FILE = os.path.join(DATA_DIR, "Without LRB NLTHA_Acc.csv")

DATA_DIR = r"D:\Coordinate_form_code_100KL\Data"
os.makedirs(DATA_DIR, exist_ok=True)
CSV_FILE = os.path.join(DATA_DIR, "Without LRB NLTHA_D.csv")
...
CSV_HEADERS = [
    ...
    "PFA Node 1009 (g)",
    "PFA Node 9003 (g)",
    "Maximum LRB Displacement (Node 1001) (mm)",
    "Maximum Top Displacement (Node 1009) (mm)"
]
...
GM_input_file = f"D:/Coordinate_form_code_100KL/GM/D/RSN_{GM_RSN}.txt"
...
while ok == 0 and tCurrent < tFinal: 
    ...
    if LRB_inclusion == 1:
        total_height = 28425.0 + h_LRB
    else:
        total_height = 28425.0
...
# Peak Floor Accelerations for nodes  1001, 1005, 1009, 9003
pfa_nodes = [1001, 1005, 1009, 9003]
