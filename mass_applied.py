...
weight_empty_tand_and_water = ((mass_empty_tank + mass_water) * g) / (3890.0 * 4)
...
def UDL_applier():
    ...
    ops.eleLoad('-ele', *staging_beams, '-type', '-beamUniform',  -staging_beam_self_weight, 0.0 , 0.0)
    ops.eleLoad('-ele', *tank_bottom_beams, '-type', '-beamUniform',  -tank_bottom_beam_self_weight, 0.0, 0.0)
    ops.eleLoad('-ele', *tank_bottom_beams, '-type', '-beamUniform',  -weight_empty_tand_and_water, 0.0, 0.0)
