...
control_node = 1009     # node where displacement is read
...
if LRB_inclusion == 1:
    maxDisp = 0.04 * (28425.0 + h_LRB)
else:
    maxDisp = 0.04 * 28425.0
...
# With LRB
# Maximum Base Shear = 1029.64 kN
# Displacement at Maximum Base Shear = 479.55 mm
# Drift at Maximum Base Shear = 1.69 %

# Without LRB
# Maximum Base Shear = 1468.74 kN
# Displacement at Maximum Base Shear = 331.75 mm
# Drift at Maximum Base Shear = 1.18 %